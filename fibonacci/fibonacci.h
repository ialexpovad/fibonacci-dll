// fibonacci.h - Contains declarations of Fibonacci functions
#pragma once
...
extern "C" FIBONACCI_API void fibonacci_init(const unsigned long long a, const unsigned long long b);
